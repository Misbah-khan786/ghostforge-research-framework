...
from GHOSTFORGE.GhostForge import initialize_genesis, apply_ghostforge, update_scores
from Network.Delaymatrix import MinerDelayMatrix  # Assuming you have the MinerDelayMatrix class in a separate file
from DAGVisulizer.dagvisualizerMan import DAGVisualizer
...
class Miner:
    ...
    def visualize_current_dag(self, block_id=None, context=""):
        ...
        output_dir = f'Man_output_directory/{self.miner_id}'
