...
from GHOSTFORGE.GF_New_JMaxTip  import initialize_genesis, apply_ghostforge, update_scores
from Network.Delaymatrix import MinerDelayMatrix  # Assuming you have the MinerDelayMatrix class in a separate file
from DAGVisulizer.dagVisulizer_Jmaxtip import DAGVisualizer
...
class Miner:
    ...
    def visualize_current_dag(self, block_id=None, context=""):
        ...
        output_dir = f'NMax_TIpoutput_directory/{self.miner_id}'
