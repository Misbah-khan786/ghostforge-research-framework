...
class DAGVisualizer:
    ...
    def visualize_dag(self, dag, blue_set, red_set, blue_scores, output_path='Man_output_directory/graph_output', order_list=None):
    ...
    def visualize_dag(self, dag, blue_set, red_set, blue_scores, output_path='Man_output_directory/graph_output',
                      order_list=None):
        """Visualize dag used by the GhostForge research simulation."""
        os.environ["PATH"] += os.pathsep + 'C:/Program Files/Graphviz/bin/'
        dot = Digraph(engine="dot")
