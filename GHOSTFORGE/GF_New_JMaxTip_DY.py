...
def block_level_coloring_and_scoring(dag, block, red_set, blue_set, blue_scores, k, visualizer):
    ...
    # Perform block-level ordering based on the current block's past blocks
    block_level_ordered_list = block_level_ordering(dag, block, blue_scores)
    # print(f" Block Level Order of Block {block}: {block_level_ordered_list}")
...
def dag_level_coloring_and_ordering(dag, blue_set, red_set, blue_scores, k, previous_order, miner_id, previous_max_tip):
    ...
    new_order = inherit_and_determine_order(dag, blue_set, red_set, blue_scores, k, previous_order, tips_list, max_tip,
                                            previous_max_tip)
    print(f"Final Ordered List for MINER-ID {miner_id}: {new_order}")
